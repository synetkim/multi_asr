...
class Spectrogram {
 public:
  ...
  void ComputeFFTwithPhase(const VectorBase<BaseFloat> &wave,
               Matrix<BaseFloat> *output,
               Vector<BaseFloat> *wave_remainder = NULL);

  void ComputeFFTwithPhaseDifference(const VectorBase<BaseFloat> &wave1, 
  ...
  void ComputeFFTwithCoeff(const VectorBase<BaseFloat> &wave,
               Matrix<BaseFloat> *output,
               Vector<BaseFloat> *wave_remainder = NULL);
