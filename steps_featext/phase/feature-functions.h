...
void ComputePowerSpectrumPhase(VectorBase<BaseFloat> *complex_fft);

BaseFloat ComputePD(BaseFloat angle1, BaseFloat angle2);

void ComputePowerSpectrumPhaseDifference(VectorBase<BaseFloat> *complex_fft, 
										VectorBase<BaseFloat> *complex_fft1,
										VectorBase<BaseFloat> *complex_fft3,
										VectorBase<BaseFloat> *complex_fft4,
										VectorBase<BaseFloat> *complex_fft5,
										VectorBase<BaseFloat> *complex_fft6,
										VectorBase<BaseFloat> *complex_fft7
										);
