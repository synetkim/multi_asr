...
steps/align_fmllr.sh --nj 4 \
  $newdata/dt05_real_$enhan data/lang exp/tri3b_tr05_multi_$enhan exp/tri3b_tr05_multi_${enhan}_ali_dt05 || exit 1;
...
for x in tr05_multi_$enhan ; do
  ...
  steps/nnet/make_fmllr_ivector_feats.sh --cmd "$train_cmd" \
     ...
     $dir $newdata/$x $gmmdir $dir/log exp/nnet2_online/ivectors_tr05_multi_$enhan $dir/data || exit 1
  steps/compute_cmvn_stats.sh $dir $dir/log $dir/data || exit 1;
done
