...
utils/combine_data.sh $target_scp_dir/tr05_multi_noisy $target_scp_dir/tr05_simu_noisy $target_scp_dir/tr05_real_noisy
utils/combine_data.sh $target_scp_dir/dt05_multi_noisy $target_scp_dir/dt05_simu_noisy $target_scp_dir/dt05_real_noisy
echo "Done "
echo "==========================================="
