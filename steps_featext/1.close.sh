...
utils/combine_data.sh $target_scp_dir/tr05_multi_close $target_scp_dir/tr05_simu_close $target_scp_dir/tr05_real_close
utils/combine_data.sh $target_scp_dir/dt05_multi_close $target_scp_dir/dt05_simu_close $target_scp_dir/dt05_real_close
echo "Done "
echo "==========================================="
