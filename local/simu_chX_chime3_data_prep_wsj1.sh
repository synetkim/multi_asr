...
echo "extract ${numCH}th channel (CH${numCH}.wav, the center bottom edge in the front of the tablet) for noisy data"
...
list_set="tr05_simu_wsj1_noisy${numCH}"

cd $dir

searchCH="*${numCH}.wav"

find $audio_dir -name $searchCH | grep 'tr05_bus_simu_new\|tr05_caf_simu_new\|tr05_ped_simu_new\|tr05_str_simu_new' | sort -u > tr05_simu_wsj1_noisy${numCH}.flist
...
cat tr05_simu_wsj1_noisy${numCH}_wav.scp | awk -F'[_]' '{print $2}' | tr '[A-Z]' '[a-z]' \
    | $local/find_noisy_transcripts.pl dot_files_wsj1.flist | cut -f 2- -d" " > tr05_simu_wsj1_noisy${numCH}.txt
cat tr05_simu_wsj1_noisy${numCH}_wav.scp | cut -f 1 -d" " > tr05_simu_wsj1_noisy${numCH}.ids
paste -d" " tr05_simu_wsj1_noisy${numCH}.ids tr05_simu_wsj1_noisy${numCH}.txt | sort -k 1 > tr05_simu_wsj1_noisy${numCH}.trans1
