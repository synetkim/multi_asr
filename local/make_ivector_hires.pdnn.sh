...
if [ $stage -le 1 ]; then
  for datadir in et05_real_${enhan} et05_simu_${enhan} tr05_real_${enhan} tr05_simu_${enhan} dt05_real_${enhan} dt05_simu_${enhan}; do
    utils/copy_data_dir.sh $indata/$datadir data/${datadir}_hires
...
if [ $stage -le 2 ]; then
  ...
  steps/align_fmllr.sh --nj $nj --cmd "$train_cmd" \
    $indata/tr05_multi_${enhan} data/lang exp/tri3b_tr05_multi_${enhan} exp/nnet2_online/tri3b_tr05_multi_${enhan}_ali
fi
