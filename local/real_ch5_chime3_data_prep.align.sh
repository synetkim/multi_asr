...
if $eval_flag; then
list_set="tr05_real_noisy5 dt05_real_noisy5 et05_real_noisy5"
else
list_set="tr05_real_noisy5 dt05_real_noisy5"
fi
...
cat tr05_real.dot | sed -e 's/(.*)//' > tr05_real_noisy5.txt
paste -d" " tr05_real_noisy5.ids tr05_real_noisy5.txt | sort -k 1 > tr05_real_noisy5.trans1
cat dt05_real.dot | sed -e 's/(\(.*\))/\1/' | awk '{print $NF ".CH5_REAL"}'> dt05_real_noisy5.ids
cat dt05_real.dot | sed -e 's/(.*)//' > dt05_real_noisy5.txt
paste -d" " dt05_real_noisy5.ids dt05_real_noisy5.txt | sort -k 1 > dt05_real_noisy5.trans1
if $eval_flag; then
cat et05_real.dot | sed -e 's/(\(.*\))/\1/' | awk '{print $NF ".CH5_REAL"}'> et05_real_noisy5.ids
cat et05_real.dot | sed -e 's/(.*)//' > et05_real_noisy5.txt
paste -d" " et05_real_noisy5.ids et05_real_noisy5.txt | sort -k 1 > et05_real_noisy5.trans1
fi
