...
echo "==========================================================="
#sykim
aligned_wav_path=/data-local/sykim/database/CHiME3/data/audio/16kHz/isolated_aligned/tr05_org/
awk -F ' ' '{print $1}' data/tr05_orig_clean/wav.scp >data/tr05_orig_clean/wav.scp.bk
rm data/tr05_orig_clean/wav.scp
cat data/tr05_orig_clean/wav.scp.bk | while read line; do
 	org_utt=$line
	utt=${line^^}
	aligned_wav=`find $aligned_wav_path -name "*$utt*"`
	echo "$org_utt $aligned_wav" >>data/tr05_orig_clean/wav.scp
done
echo "Convert original wav file to aligned wav file (wav.scp)"
wc -l data/tr05_orig_clean/wav.scp
echo "Done."
echo "==========================================================="
