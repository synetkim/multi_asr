...
#from models.cnnv import CNNV
from models.crnv import CRNV
...
if __name__ == '__main__':
    ...
    cfg = NetworkConfig(); cfg.model_type = 'CRNV'
    ...
    cnn = CRNV(numpy_rng=numpy_rng, theano_rng = theano_rng, cfg = cfg)
