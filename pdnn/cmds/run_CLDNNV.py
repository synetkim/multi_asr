...
if __name__ == '__main__':
    ...
    required_arguments = ['train_data', 'valid_data','conv_nnet_spec','lstm_nnet_spec', 'nnet_spec', 'wdir']
    ...
    cfg = NetworkConfig();cfg.model_type = 'CLDNNV'
    cfg.parse_config_cldnn(arguments, nnet_spec, conv_nnet_spec, lstm_nnet_spec)
