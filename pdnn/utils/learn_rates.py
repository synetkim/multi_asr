...
class LearningRateExpDecay(LearningRate):
    ...
    def get_next_rate(self, current_error):
        ...
        self.epoch += 1
        #print "LearningRateExpDecay:" + str(diff_error)
        return self.rate
...
class LearningMinLrate(LearningRate):
    ...
    def get_next_rate(self, current_error):
        ...
        self.epoch += 1
        #print "[LearningRateExpDecay] diff_error:" + str(diff_error)+", self.min_derror_decay_start:" +str(self.min_derror_decay_start)
        return self.rate
