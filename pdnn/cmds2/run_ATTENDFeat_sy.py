...
from models.attend import ATTEND, ATTEND_Forward
...
if __name__ == '__main__':
    ...
    log('> ... setting up the ATTENDRNN layers')
    rng = numpy.random.RandomState(89677)
    theano_rng = RandomStreams(rng.randint(2 ** 30))
    cfg.init_activation() 
    lstm = ATTEND_Forward(numpy_rng=rng, lstm_layer_configs = cfg, n_ins = cfg.n_ins)
