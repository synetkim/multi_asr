    ...
    def __init__(self, numpy_rng, theano_rng=None,
        ...
        for i in xrange(self.lstm_layers_number):
            ...
            lstm_layer = AttendLSTMLayer(rng=numpy_rng, input=input, n_in=input_size, 
                                         n_out=self.lstm_layers_sizes[i], steps=cfg.batch_size)
            print '\tbuild AttendLSTMLayer: ' + str(input_size) +' x '+ str(lstm_layer.n_out)
        ...
        self.errors = self.layers[-1].l2(self.y)
...
#class ATTENDLSTM_Forward(object):
...
#
#            lstm_layer = AttendLSTMLayer(rng=numpy_rng, input=input,
#		                                n_in=n_ins,
