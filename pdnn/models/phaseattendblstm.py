...
class PhaseATTEND_LSTM(object):
    ...
    def __init__(self, numpy_rng, theano_rng=None,
        ...
        for i in xrange(1):
            ...
            # Backward
            b_lstm_layer = AttendLSTMLayer(rng=numpy_rng, input=input, n_in=input_size, n_out=self.lstm_layers_sizes[i], 
                                                extra_input=self.extra_x, n_extra_in=self.extra_dim,
                                                backwards=True,
                                                steps=cfg.batch_size, draw=draw)
        ...
        print '1. finish PhaseAttendLSTMLayer: '+ str(self.bilayers[-1].n_out)
