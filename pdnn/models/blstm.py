...
from layers.lstm import LSTMLayer, SUMLayer
...
class LSTMV(object):
    ...
    def build_extract_feat_function(self):
        feat = T.matrix('feat')
        out_da = theano.function([feat], self.layers[-1].output, updates = None, givens={self.x:feat}, on_unused_input='warn')
        return out_da
